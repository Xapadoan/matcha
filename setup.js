...
connection.query('CREATE TABLE IF NOT EXISTS users (id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL, username VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, firstname VARCHAR(100) NOT NULL, email VARCHAR(255) NOT NULL, status VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, fruit VARCHAR(20) NOT NULL)');
...
connection.query('CREATE TABLE IF NOT EXISTS users_interest (id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL, name INT NOT NULL, users TEXT(10000))');
connection.end();
