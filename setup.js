...
connection.query('CREATE TABLE IF NOT EXISTS users_interest (id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL, name VARCHAR(50) NOT NULL, users TEXT(10000))');
connection.end();
