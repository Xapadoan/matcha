...
connection.query('CREATE TABLE IF NOT EXISTS users_extended (id INT(9) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL, INT NOT user NULL, gender INT NOT NULL DEFAULT 0, orientation VARCHAR(50) NOT NULL DEFAULT Hetero, age INT NOT NULL DEFAULT 18, bio TEXT(500), interests VARCHAR(255)');
connection.end();
